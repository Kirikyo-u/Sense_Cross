...
export const siteConfig: SiteConfig = {
	...
	bangumi: {
		userId: "Resage", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
	...
	toc: {
		enable: true, // 启用目录功能
		depth: 1, // 目录深度，1-6，1 表示只显示 h1 标题，2 表示显示 h1 和 h2 标题，依此类推
	},
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Kirikyo-u/Sense_Cross",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/494238134",
					external: true,
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/Kirikyo-u/",
		},
	],
};
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		...
		skin: ["Owo", "www"], // 换装提示
		close: "QWQ", // 关闭提示
		link: "https://github.com/Kirikyo-u/Sense_Cross", // 关于链接
	},
};
